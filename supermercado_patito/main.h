...
int main() {
    ...
    do {
        ...
        cout << "7. Gestionar Ordenes de Compra" << endl;
        cout << "8. Gestionar Facturas de Venta" << endl;
        cout << "0. Salir" << endl;
        cout << "------------------------------------------" << endl;
...
// =========================================================
//                  SUBMENU DE VENTAS (FACTURAS)
// =========================================================
void menuVentas() {
    int op;
    Venta v; // Instancia de la clase Venta

    do {
        cout << "\n--- MODULO DE VENTAS ---" << endl;
        cout << "1. Realizar una Venta (Facturar)" << endl;
...
// =========================================================
//                  SUBMENU DE COMPRAS (ORDENES)
// =========================================================
void menuCompras() {
    int op;
    Compra c; // Instancia de la clase Compra

    do {
        cout << "\n--- MODULO DE COMPRAS ---" << endl;
        cout << "1. Realizar una Orden de Compra" << endl;
        cout << "0. Regresar al Menu Principal" << endl;
        cout << "Opcion: ";
        cin >> op;
